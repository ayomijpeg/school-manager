-- CreateEnum
CREATE TYPE "StudentStatus" AS ENUM ('ACTIVE', 'PROMOTED', 'GRADUATED', 'WITHDRAWN', 'REPEATING');
...
-- CreateIndex
CREATE INDEX "TimetableSlot_classId_day_idx" ON "TimetableSlot"("classId", "day");
